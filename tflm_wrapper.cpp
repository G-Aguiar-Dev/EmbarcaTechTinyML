...
int tflm_init_model(void) {
    // Aponta para o modelo dentro do array wine_mlp_float_tflite
    ...
    // Registrar apenas as operações usadas pelo MLP do wine
...
// -------------------------------------------------------------------
// Executa uma inferência no modelo wine
// -------------------------------------------------------------------
