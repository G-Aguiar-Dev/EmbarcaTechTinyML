...
#include "wine_dataset.h"          // Contém wine_features[150][4] e wine_labels[150]
#include "wine_normalization.h"    // Contém os vetores wine_means[4] e wine_stds[4]

#define NUM_SAMPLES 150            // Total de amostras no dataset wine
...
int main() {
    ...
    printf("Iniciando inferencia nas 150 amostras do dataset wine...\n");
     ...
     * Percorre todas as 150 amostras do dataset wine.
     */
